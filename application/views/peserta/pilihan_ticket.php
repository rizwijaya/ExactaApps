         ...
         <?php foreach ($ticket as $tk) : ?>
            <div class="col-lg-4">
               ...
               foreach ($dt['0'] as $cetak) : ?>
                  <div class="pricing-item <?php if (!($cetak < $tk['kapasitas'])) {
                                                echo 'disebled';
                                             } ?>">
                     ...
                     <div class="ts-pricing-box">
                        ...
                        <div class="ts-pricing-header">
                           ...
                           <h3 class="ts-pricing-price">
                              <span style="font-size:40px" class="currency">Rp. <?php echo number_format($tk['harga'], 0, ',', '.'); ?></span>
                           </h3>
                        </div>
                        ...
                        <div class="promotional-code">
                           ...
                           <?php } elseif ($this->session->userdata('id_user')) { ?>
                              <a href="<?php echo base_url(); ?>home/order_single/<?php echo $tk['id_sesi']; ?>" onclick="return confirm('Apakah anda yakin untuk membeli Ticket Exacta?')" class="btn pricing-btn">Beli Ticket</a>
                           <?php } else { ?>
