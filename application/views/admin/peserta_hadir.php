             ...
             <div class="row align-items-center">
               <div class="col">
                ...
                <div class="col text-right">
                 <a class="btn btn-primary mb-0" href="<?php echo base_url(); ?>daftarpeserta/cetak_hadir"><i class="fa fa-print"></i> Cetak Laporan</a>
               </div> 
             </div>
           </div>
           <!-- Isi Tabel -->
             ...
             <table class="table align-items-center table-flush">
               <thead class="thead-light">
                 <tr>
                   ...
                   <th scope="col" class="sort" data-sort="jam_absen">Jam Absen</th>
