         ...
         <div class="card mb-4">
           ...
           <div class="card-header border-0">
             <div class="row align-items-center">
               <div class="col">
                 <h3 class="mb-0">Data Peserta Sesi <?php echo $sesi; ?></h3>
               </div>
               <!-- Button trigger modal -->
               <div class="col text-right">
                 <a class="btn btn-primary mb-0" href="<?php echo base_url(); ?>daftarpeserta/cetak_sesi/<?php echo $sesi; ?>"><i class="fa fa-print"></i> Cetak Laporan</a>
               </div>
             </div>
           </div>
           <!-- Isi Tabel -->
